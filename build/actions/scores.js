const dataScores = [];
const utilsGetUserScore = (email) => dataScores.filter((e) => e.email === email)[0];
...
module.exports = {
    setScore: ({ input, }) => {
        ...
        if (!user) {
            ...
            return {
                success: true,
                message: "This is the first answer that was registered on your account, congratulation!",
            };
        }
        const currentKanjiScore = user.kanjis.filter((e) => e.answer === +kanjiId)[0];
